...
!
!     Ray tracing routines for RAYINVR
!
!     ----------------------------------------------------------------
!
...
!
      include 'rayinvr.par'
!      external odex,odez,odexfi,odezfi         ! ufispb:
                                                ! since these subroutines are in
                                                ! RungeKutta module now
...
!
!     determine layer and block of (x,y) point in model
!
      include 'rayinvr.par'
      real left
      include 'rayinvr.com'
